...
class TestAdCreator extends PHPUnit_Framework_TestCase {
    ...
    function testComposedJS()
    {
        ...
        $created_js = $creator->create(123, ERWP_AdCreator::IMPL_COMPOSED);
    ...
    function testComposedJSWithOtherHost()
    {
        ...
        $created_js = $creator->create('test', ERWP_AdCreator::IMPL_COMPOSED);
    ...
    {
        $creator = new ERWP_AdCreator();
        $created_js = $creator->create('99,12,34', ERWP_AdCreator::IMPL_COMPOSED);
    ...
    function testFifWithOutBreakPoints()
    {
        ...
        $created_js = $creator->create(123, ERWP_AdCreator::IMPL_FIF);
        ...
        $ad_index = ERWP_AdCreator::currentAdIndex();
        $created_js = $creator->create('666,12,33', ERWP_AdCreator::IMPL_FIF);
    ...
    function testFifWithBreakPoints()
    {
        ...
        $ad_index = ERWP_AdCreator::currentAdIndex();
        $created_js = $creator->create('11,12', ERWP_AdCreator::IMPL_FIF);
        ...
        // Only one cu
        $ad_index = ERWP_AdCreator::currentAdIndex();
        $created_js = $creator->create('11', ERWP_AdCreator::IMPL_FIF, 200);
        $expected_js = '<div id="emediate-fif-'.$ad_index.'" class="emediate-ad fif" data-ad-index="'.$ad_index.
